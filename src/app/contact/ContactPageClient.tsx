...
export default function ContactPageClient({ contact, social }: ContactPageClientProps) {
  ...
  const socialLinks = [
    { name: "Facebook", icon: Facebook, href: social.facebook, color: "hover:bg-blue-600" },
    { name: "Instagram", icon: Instagram, href: social.instagram, color: "hover:bg-gradient-to-br hover:from-pink-500 hover:to-purple-600" },
    { name: "YouTube", icon: Youtube, href: social.youtube, color: "hover:bg-red-600" },
  ];
  ...
  const contactInfo = [
    {
      icon: MapPin,
      title: "Visit Us",
      content: `${contact.address.street}, ${contact.address.suburb}`,
      subContent: `${contact.address.state} ${contact.address.postcode}`,
      action: {
    ...
    },
    {
      ...
      action: {
        label: "Send Email",
        href: `mailto:${contact.email}?subject=${encodeURIComponent('Contact Enquiry - Australian Islamic Centre')}`,
        external: true,
      },
    },
    {
      icon: Clock,
      title: "Opening Hours",
      content: contact.openingHours.length > 0
        ? contact.openingHours[0].hours
        : "Open Daily: Fajr to Isha",
      subContent: contact.openingHours.length > 1
          ...
          <div className="grid lg:grid-cols-5 gap-12">
            ...
            <FadeIn direction="right" delay={0.2} className="lg:col-span-2 space-y-6">
                ...
                <div className="flex items-center gap-3">
                  {socialLinks.map((socialItem) => (
                    <a
                      ...
                      className={`w-12 h-12 rounded-xl bg-gray-100 flex items-center justify-center text-gray-600 hover:text-white transition-all ${socialItem.color}`}
              ...
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100">
                ...
                <div className="p-4">
                  <p className="text-sm text-gray-600 mb-3">{contact.address.full}</p>
                  <a
                    href={`https://maps.google.com/?q=${encodeURIComponent(contact.address.full)}`}
                    target="_blank"
                    rel="noopener noreferrer"
