  ...
  return (
    ...
    >
      ...
      <div className="p-6 flex-1 flex flex-col">
        ...
        <p className="text-gray-600 mb-4 flex-1 line-clamp-2">{program.description}</p>
        ...
        <motion.div animate={{ y: isHovered ? 0 : 4, opacity: isHovered ? 1 : 0.8 }} transition={{ duration: 0.2 }}>
          {program.externalLink ? (
            <Button
            ...
            <Button href="/contact" variant="outline" size="sm" icon={<ArrowRight className="w-4 h-4" />} className="w-full">
              Learn More
            </Button>
          )}
        </motion.div>
...
export default function ProgramsPageClient({ programs }: ProgramsPageClientProps) {
  const educationPrograms = programs.filter((p) => p.category === "Education" || p.category === "education");
  const youthPrograms = programs.filter((p) => p.category === "Sports & Youth" || p.category === "youth" || p.category === "sports");
          ...
          <FadeIn>
            <div className="text-center">
              ...
              <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
                Transformative{" "}
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-lime-400">Programs</span>
              </h1>
              <p className="text-xl text-white/80 max-w-2xl mx-auto">
                Comprehensive Islamic education and community programs designed to nurture faith, knowledge, and personal
        ...
        <div className="max-w-7xl mx-auto px-6">
          <FadeIn>
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Islamic Education for All Ages</h2>
              <p className="text-gray-600 max-w-2xl mx-auto">
                Our education programs provide comprehensive Islamic learning, from Quran recitation to advanced Islamic studies.
              </p>
            </div>
          </FadeIn>
          ...
          <div className="space-y-24">
            {educationPrograms.map((program, index) => {
              ...
              return (
                <FadeIn key={program.id} direction={isEven ? "left" : "right"}>
                  <div id={program.id} className={`grid lg:grid-cols-2 gap-12 items-center ${!isEven ? "lg:flex-row-reverse" : ""}`}>
                    <motion.div whileHover={{ scale: 1.02 }} className={`relative ${!isEven ? "lg:order-2" : ""}`}>
                      <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                        <Image src={program.image} alt={program.title} width={600} height={400} className="w-full h-[400px] object-cover" />
                        <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent" />
                        <div className="absolute bottom-6 left-6 right-6">
                          <div className="flex items-center gap-3">
                            <span className="px-3 py-1 bg-green-500 text-white text-sm font-medium rounded-full">{program.category}</span>
                            <span className="px-3 py-1 bg-white/20 backdrop-blur-sm text-white text-sm rounded-full">{program.schedule}</span>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className={`${!isEven ? "lg:order-1" : ""}`}>
                      ...
                      <h3 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">{program.title}</h3>
                      ...
                      <div className="flex items-center gap-3 mb-6 p-4 bg-white rounded-xl shadow-sm">
                        ...
                        <div>
                          ...
                          <p className="font-semibold text-gray-900">{program.schedule}</p>
                        </div>
                      </div>
                      ...
                      <div className="flex flex-wrap gap-4">
                        ...
                        <Button href="/contact" variant="outline" icon={<Calendar className="w-5 h-5" />}>
            ...
            <div className="bg-gradient-to-r from-red-50 to-orange-50 rounded-3xl p-8 md:p-12 border border-red-100">
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div>
                  ...
                  <h2 className="text-3xl font-bold text-gray-900 mb-4">AIC College</h2>
                  <p className="text-gray-600 mb-6">
                    Australian International College offers accredited Islamic education from primary through secondary levels.
                    Providing quality education that nurtures both academic excellence and Islamic values.
                  </p>
                  <Button
                    href={aicInfo.externalLinks.college}
                    target="_blank"
                ...
                <div className="relative">
                  <div className="aspect-video rounded-2xl overflow-hidden shadow-xl">
                    <Image src="/images/aic 1.jpg" alt="AIC College" width={600} height={400} className="w-full h-full object-cover" />
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <FadeIn>
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Building Character Through Sport & Community</h2>
              <p className="text-gray-600 max-w-2xl mx-auto">
                Our youth programs combine physical activity with Islamic values, fostering leadership, teamwork, and personal growth.
              </p>
            </div>
          </FadeIn>
          ...
          <FadeIn>
            <div className="bg-gradient-to-br from-neutral-800 via-neutral-700 to-sage-700 rounded-3xl p-8 md:p-12">
              <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Our Educational Impact</h2>
                <p className="text-white/70 max-w-2xl mx-auto">
                  Join thousands of students who have transformed their lives through our comprehensive Islamic education programs.
                </p>
              </div>
      ...
      <section className="py-20 bg-neutral-50">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <FadeIn>
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">Ready to Begin Your Learning Journey?</h2>
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Enroll today and join our community of learners seeking knowledge and spiritual growth. Contact us for enrollment details
              and class schedules.
            </p>
