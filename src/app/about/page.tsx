...
import { stats, aicInfo, partners } from "@/data/content";
import {
  ArrowRight,
  Heart,
  Users,
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <FadeIn>
              <div className="bg-white rounded-2xl p-8 shadow-lg h-full">
                ...
                <p className="text-gray-600 leading-relaxed">
                  To be a leading Islamic centre that serves as a bridge between Australian and Islamic
                  values. We envision a thriving Muslim community that is deeply rooted in Islamic
                  teachings while actively contributing to the broader Australian society through
                  education, community service, and interfaith dialogue.
                </p>
              </div>
            </FadeIn>
            ...
            <FadeIn delay={0.2}>
              <div className="bg-white rounded-2xl p-8 shadow-lg h-full">
                ...
                <p className="text-gray-600 leading-relaxed">
                  We embrace a holistic approach to community service, combining traditional Islamic
                  scholarship with contemporary understanding. Our award-winning architecture itself
                  reflects this philosophy - a modern Australian design that incorporates traditional
                  Islamic elements, creating something truly unique.
                </p>
              </div>
            </FadeIn>
          </div>
