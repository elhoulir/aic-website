    ...
    return (
      ...
      >
        ...
        <div className="md:w-2/3 p-6 flex flex-col justify-center relative">
          ...
          <motion.div animate={{ opacity: isHovered ? 1 : 0.8, x: isHovered ? 4 : 0 }}>
            <Button
        ...
        <AnimatePresence mode="wait">
          {isHovered ? (
            ...
            <motion.div key="preview" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
              ...
              <p className="text-xs text-gray-400 text-center">Hover for more details</p>
            </motion.div>
          )}
        </AnimatePresence>
      </div>
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-2 bg-gray-100 rounded-lg p-1">
              <button
                ...
                className={`p-2 rounded-md transition-all ${viewMode === "grid" ? "bg-white shadow text-green-600" : "text-gray-500"}`}
              >
              ...
              {Array.from({ length: 35 }, (_, i) => {
                ...
                const hasRecurringEvent =
                  ...
                  events.some((event) => {
                    ...
                    return recurringDay === dayNames[dayOfWeek] || (recurringDay === "Weekends" && (dayOfWeek === 0 || dayOfWeek === 6));
                  });
          ...
          <AnimatePresence mode="wait">
            {filteredEvents.length > 0 ? (
              ...
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-center py-16">
                ...
                <p className="text-gray-500">Try adjusting your filters or search query to find events.</p>
              </motion.div>
            )}
          </AnimatePresence>
        </div>
          ...
          <FadeIn>
            <div className="bg-gradient-to-r from-green-600 to-primary-700 rounded-3xl p-8 md:p-12 text-center">
              ...
              <p className="text-white/80 mb-8 max-w-xl mx-auto">
                Subscribe to our newsletter and get notified about upcoming events, programs, and community gatherings.
              </p>
              <form
